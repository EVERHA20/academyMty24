...
public class JdbcUpdateDemoV1 {
	...
	private static void displayEmployee(Connection myConn, String firstName, String lastName) throws SQLException {
		...
		try {
			// Prepare statement
			myStmt = myConn                                                                               // INYECCION SQL                   
					.prepareStatement("select last_name, first_name, email from employees where last_name='"+ lastName +"' and first_name='"+ firstName +"'");
